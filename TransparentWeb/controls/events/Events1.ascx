<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Events1.ascx.cs" Inherits="transparent.controls.events.EventsDemo1" %>
...
<div style="padding:1em;border:1px solid blue;text-align:center;">
    ...
    <asp:Button runat="server" ID="btnDown" Text="Lower" onclick="btnDown_Click" />
    <%-- Current Temp: <%= Temperature %>'C --%>
    <asp:Button runat="server" ID="btnUp" Text="Raise" onclick="btnUp_Click" />
